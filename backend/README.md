...
## Project Structure
    ...
    ├── testapiautostorybo_112843  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_112843`
...
2. Clone this repo and `cd testapiautostorybo_112843`
